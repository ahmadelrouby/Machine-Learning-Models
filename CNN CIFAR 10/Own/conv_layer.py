...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 31 21:55:37 2018
...
class ConvolutionalLayer:
    ...
    def __init__(self,
        ...
        num_filters: number of filters to be applied in this layer
        filter_dims: dimensions of filter(Channel(same as input channel), Width, Height)
        stride: Stride for the filter
        padding: (Number) 
        
        
        Output Shape should be (Number of Filters, Activation Map Width, Activation Map Height)
        ...
        self.O = int((self.N_input-self.F_filter)/self.S_filter) + 1 #Dimensions for Activation Map
        
        #print (self.O) 
        self.output_shape = (self.num_filters,self.O,self.O) #Output Shape for FULL Activation Map
        
        print (self.output_shape) 
        
        """
        
        Now we need to initialize the weights and Bias
